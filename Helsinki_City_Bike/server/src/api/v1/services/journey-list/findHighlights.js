...
const findHighlights = async () => {
    ...
    const totalDistanceInKilometersInJune = Math.round(totalDurationAndDistanceInJune[1] / 1000);
    const averageDurationInJune = Math.round(totalDurationAndDistanceInJune[0] / totalRowsInJune);
    const averageDistanceInJune = Math.round(totalDurationAndDistanceInJune[1] / totalRowsInJune);
    ...
    const totalDistanceInKilometersInJuly = Math.round(totalDurationAndDistanceInJuly[1] / 1000);
    const averageDurationInJuly = Math.round(totalDurationAndDistanceInJuly[0] / totalRowsInJuly);
    const averageDistanceInJuly = Math.round(totalDurationAndDistanceInJuly[1] / totalRowsInJuly);
