        ...
        await transporter.sendMail({
            ...
            <div style="position: relative; height: 100vh; width: 100%;  background-color: #efefef">
                <div style="padding: 36px 0;width: 100%; text-align: center">
                    <a href="#" style=" font-size: 24px; font-weight: 500; color: #030303; letter-spacing: 1px; text-decoration: none">Helsinki City Bike</a>
                </div>
                    <div
                        ...
                        <p style="font-size: 16px; color: #737F8D;">Thanks for registering for an account on Helsinki City Bike! Before we get
                    ...
                    <div>
                        <p style="margin: 0; padding: 0; color: #747F8D">Need help? <a href="#">Contact our support team</a> or hit us up on Instagram <a href="#">@Helsinki City Bike</a>.
                        </p>
                ...
                <div style="margin: 20px; text-align: center">
                    <p style="margin: 5px; padding: 0; font-size: 12px; color: #99AAB5">Sent by Helsinki City Bike - <a href="#">check our blog</a> - <a href="#">@Helsinki City Bike</a>.
                    </p>
